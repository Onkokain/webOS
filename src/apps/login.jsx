...
export default function Login({ onLogin }) {
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="flex h-screen w-screen flex-col items-center justify-center bg-black gap-8"
    >
      <div className="flex flex-col items-center gap-2">
        <img
          ...
          height="80"
        />
        <p className="text-gray-600 font-mono text-sm tracking-[0.3em]">
          Suprland*
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-64">
        ...
        <button
          type="submit"
          className="mt-1 border border-gray-800 hover:border-gray-600 text-gray-500 hover:text-gray-300 font-mono text-xs tracking-widest uppercase py-2 rounded-lg transition-colors"
        >

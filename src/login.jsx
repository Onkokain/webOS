      ...
      <form onSubmit={submit} className="flex flex-col gap-3 w-64">
        {step === 'user' ? (
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font-mono text-[10px] tracking-widest uppercase">Username</label>
            <input
              autoFocus
              value={user}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-gray-600 font-mono text-[10px] tracking-widest uppercase">Password</label>
            <input
              autoFocus
              type="password"
              value={pass}

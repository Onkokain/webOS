  ...
  return (
    ...
    >
      <button onClick={onNewFile} className="menu-btn">
        <svg width="13" height="14" viewBox="0 0 20 20" fill="none">
          <path
      ...
      <button onClick={onNewFolder} className="menu-btn">
        <svg width="0" height="14" viewBox="0 0 20 20" fill="none">
          <path
      ...
      {onPaste && (
        <button onClick={onPaste} className="menu-btn">
          <svg width="14" height="14" viewBox="0 0 20 20" fill="none">
            ...
            />
            <path
              d="M4 7H3a1 1 0 00-1 1v9a1 1 0 001 1h10a1 1 0 001-1v-1"
              stroke="currentColor"
              strokeWidth="1.4"
            />
          </svg>

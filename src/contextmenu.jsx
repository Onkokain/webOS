...
export default function ContextMenu({ x, y, onNewFile, onNewFolder, onPaste, onClose }) {
  ...
  return (
    <div className="fixed z-50 flex flex-col py-1 rounded-xl overflow-hidden"
      ...
      <button onClick={onNewFile} className="flex items-center gap-2.5 px-4 py-2 text-gray-400 hover:text-gray-200 hover:bg-white/5 font-mono text-xs transition-colors text-left">
      ...
      <button onClick={onNewFolder} className="flex items-center gap-2.5 px-4 py-2 text-gray-400 hover:text-gray-200 hover:bg-white/5 font-mono text-xs transition-colors text-left">
        <svg width="14" height="14" viewBox="0 0 20 20" fill="none">
      ...
      {onPaste && (
        <button onClick={onPaste} className="flex items-center gap-2.5 px-4 py-2 text-gray-400 hover:text-gray-200 hover:bg-white/5 font-mono text-xs transition-colors text-left">
          <svg width="14" height="14" viewBox="0 0 20 20" fill="none">

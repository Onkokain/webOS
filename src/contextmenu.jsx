  ...
  return (
    ...
    >
      <button onClick={onNewFile}
        className="flex items-center gap-2.5 px-4 py-2 text-gray-400 hover:text-gray-200 hover:bg-white/5 font-mono text-xs tracking-wide transition-colors text-left">
